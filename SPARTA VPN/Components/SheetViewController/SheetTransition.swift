...
public class SheetTransition: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    public func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        if self.presenting {
            guard let presenter = transitionContext.viewController(forKey: .from), let sheet = transitionContext.viewController(forKey: .to) as? SheetPresentationController else {
            ...
            let sheet = transitionContext.viewController(forKey: .from) as? SheetPresentationController else {
                transitionContext.completeTransition(true)
                return
            }
